// 环境入口：dev1
// 完整 k6 入口（options/setup/teardown/default），按需在此调整 dev1 专属场景组合。
...
export function scenarios_item(data) {
  ...
  // 基线空间
  testmanagerScenarios.testmanager_baseline_space();
  // 测试设计场景
  testmanagerScenarios.testmanager_design_flow()
  // 导入场景
